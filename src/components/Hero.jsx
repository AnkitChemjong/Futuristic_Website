  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      >
        <div>
          <div
            className="mask-click-path absolute-center absolute z-50 size-64
        ...
        right-5 z-40 bg-[url('/img/contact-1.webp')] text-transparent bg-center bg-cover bg-no-repeat bg-clip-text"
        >
          G<b>a</b>ming
        </h1>
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            <h1 className="special-font hero-heading bg-[url('/img/entrance.webp')] text-transparent bg-center bg-cover bg-no-repeat bg-clip-text">
              redefi <b>n</b>e
            </h1>
